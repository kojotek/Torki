...
public class NeuroDriver extends Controller {
    ...
    boolean pulse = true;
        ...
        public NeuroDriver(NeuralNetwork n) {
        this.nn = n;
...
//fis.setVariable("opponent" + i, opponents[i]);
       ...
       nn.calculate();
        ...
        toReturn.steering = networkOutput[0];
        toReturn.accelerate = networkOutput[1];
        //toReturn.brake = brake.getValue();
        double brakeRaw = networkOutput[2];
