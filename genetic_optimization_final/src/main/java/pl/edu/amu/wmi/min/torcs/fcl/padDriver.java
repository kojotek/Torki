...
//for (int i = 0; i < opponents.length; i++) {
        ...
        */
        ...
        if (
                //(counter > Consts.earlyKillAfter && distanceRaced < 100.0f)|| 
        ...
        if (lapsDone >= Consts.lapsPerCandidate || counter > Consts.maxTicksPerCandidate ){
            ...
            System.err.println("distanceRaced * (1.0f/racingLineAverageDist) * (1.0f+trackCompleted)");
